...
//       <h3>₹{product.sale_price || product.base_price}</h3>
//     </div>
//   );
// }
          ...
          <div className="thumbnail-list">
            ...
            {product.media?.map((item, index) => (
              ...
              <img
                ...
                alt={product.title}
                className={`thumbnail ${
                  mainImage === item.media_url
                    ? "active-thumbnail"
                    : ""
                }`}
                onClick={() =>
                  setMainImage(item.media_url)
                }
              />
            ...
            ?.map((item) => (
              ...
              >
                ...
                <div className="related-image-box">
                  ...
                  <img
                    src={
                      item.media?.find((x) => x.is_primary)
                        ?.media_url ||
